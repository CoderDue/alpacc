...
# Test the JSON grammar using the alpacc CUDA backend.
...
echo "Testing JSON grammar with CUDA backend (length=$length, arch=$arch)..."
...
echo "All JSON CUDA backend tests passed."
